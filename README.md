...
1. Certifique-se de ter um servidor local instalado (como **XAMPP** ou **WAMP**).
2. Crie uma pasta para o projeto dentro do diretório público do seu servidor:
...
4. Abra o Painel de Controle do XAMPP/WAMP e inicie o serviço **Apache**.
5. Abra o seu navegador e acesse: `http://localhost/escola/listar.php`
